...
public class StoreCalendarsPage {
	...
	public void verificationOfCalender(String statusOfCalender) {
		...
		String service = services.split("of ")[1].split("service")[0].trim();
		System.out.println(service);
		int no_of_services = Integer.parseInt(service);
		List<WebElement> statusOfCalenders = driver
				.findElements(By.xpath("//div[@data-control-name='lblServiceStatusSSVS']"));
	...
	public void editSelectedSlot(String serviceName) {
		...
		//WebElement addCalender = driver.findElement(By.xpath("//*[contains(text(),'"+serviceName+"')]/ancestor::div[@data-control-name='lblServiceSSVS']//following-sibling::div[@data-control-name='btnicnAddCalendarSSVS']//following-sibling::div[text()='ADD CALENDAR']"));
		//addCalender.click();
