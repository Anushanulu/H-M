...
=============================pending = need to complete =====================================
  ...
  Scenario Outline: Verify User gets slot cancellation email for Resell Portal booking
    ...
    Examples: 
      ...
      | WEEKDAY | Sweden  | Hansa     | Resell      | Store Open  |       11 |     2022 | May       |     11 |   2024 | May     | 10:00         | Swetha serviceclose | swethahcl960@gmail.com |     910812081 | tumkur         |          572102 | tumkur      | weekday@second.com |    2022 | August     |      27 |
